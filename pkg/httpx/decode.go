// Package httpx provides small HTTP helpers shared by REST handlers.
//
// The package is intentionally narrow: each helper exists to remove a
// pattern that was being copy-pasted across handlers (and frequently
// drifting in subtle ways). Anything bigger than a few lines should
// probably live closer to the domain it serves.
package httpx
